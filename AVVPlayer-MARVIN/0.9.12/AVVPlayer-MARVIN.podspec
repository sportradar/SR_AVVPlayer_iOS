...
s.license = {'type'=>'Sportradar', 'file'=>'AVVPlayer-MARVIN-0.9.12/LICENSE.txt'}
s.authors = {'Mobile Development Team'=>'dev.apps@laola1.at'}
s.homepage = 'https://mdp.sportradar.com'
s.requires_arc = true
s.framework = 'SystemConfiguration','MobileCoreServices'
s.source = { :http => 'https://github.com/sportradar/SR_AVVPlayer_iOS/raw/master/Framework/AVVPlayer-MARVIN-iOS-0.9.12_44.zip'}
...
s.vendored_frameworks  = 'AVVPlayer-MARVIN-0.9.12/AVVPlayer.framework'
