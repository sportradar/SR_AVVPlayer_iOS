...
s.source = { :http => 'https://github.com/sportradar/SR_AVVPlayer_iOS/raw/master/Framework/AVVPlayer-MARVIN-iOS-0.9.3_34.zip'}
...
s.vendored_frameworks  = 'AVVPlayer-MARVIN-0.9.3/AVVPlayer.framework'
