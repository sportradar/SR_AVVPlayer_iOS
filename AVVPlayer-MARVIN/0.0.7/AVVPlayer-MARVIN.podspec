...
s.source = { :http => 'https://github.com/sportradar/SR_AVVPlayer_iOS/tree/master/Framework/AVVPlayer-MARVIN-iOS-0.0.7_16.zip'}
...
s.vendored_frameworks  = 'AVVPlayer-MARVIN-0.0.7/AVVPlayer.framework'
