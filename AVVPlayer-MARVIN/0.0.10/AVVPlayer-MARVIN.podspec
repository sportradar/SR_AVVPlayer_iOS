...
s.source = { :http => 'https://github.com/sportradar/SR_AVVPlayer_iOS/raw/master/Framework/AVVPlayer-MARVIN-iOS-0.0.10_29.zip'}
...
s.vendored_frameworks  = 'AVVPlayer-MARVIN-0.0.10/AVVPlayer.framework'
