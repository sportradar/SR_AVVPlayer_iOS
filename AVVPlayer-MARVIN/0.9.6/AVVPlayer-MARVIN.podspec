...
s.source = { :http => 'https://github.com/sportradar/SR_AVVPlayer_iOS/raw/master/Framework/AVVPlayer-MARVIN-iOS-0.9.6_37.zip'}
...
s.vendored_frameworks  = 'AVVPlayer-MARVIN-0.9.6/AVVPlayer.framework'
