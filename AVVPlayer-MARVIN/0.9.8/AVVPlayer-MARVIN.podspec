...
s.source = { :http => 'https://github.com/sportradar/SR_AVVPlayer_iOS/raw/master/Framework/AVVPlayer-MARVIN-iOS-0.9.8_39.zip'}
...
s.vendored_frameworks  = 'AVVPlayer-MARVIN-0.9.7/AVVPlayer.framework'
